			...
			if (Validadores.comprobarEmail(getTxtEmail().getText())) {
				...
				if (existe) {
					...
					int input = JOptionPane.showConfirmDialog(this,
							"Tu e-mail no est� registrado pero puedes inscribirte aportando datos adiccionales",
				...
				JOptionPane.showMessageDialog(this, "El email no es v�lido", "Error", JOptionPane.WARNING_MESSAGE);
			}
